...
_G.packer_plugins = {
  YouCompleteMe = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/YouCompleteMe",
  ...
  ["goyo.vim"] = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/goyo.vim",
    url = "https://github.com/junegunn/goyo.vim"
  },
  ["limelight.vim"] = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/limelight.vim",
    url = "https://github.com/junegunn/limelight.vim"
  },
  nerdtree = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  vimwiki = {
    loaded = true,
    path = "/Users/nathan/.local/share/nvim/site/pack/packer/start/vimwiki",
